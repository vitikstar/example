...
use app\modules\lessonsSchedule\models\db\NvTeacherHoursLoadSearch;
 ...
 */
class TeacherHoursLoadController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new NvTeacherHoursLoadSearch();
    ...
    {
        if (($model = NvTeacherHoursLoad::findOne($id)) !== null) {
            return $model;
        }
